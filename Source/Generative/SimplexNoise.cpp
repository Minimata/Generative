...
// Sets default values
ASimplexNoise::ASimplexNoise(float frequency, float amplitude, float lacunarity, float persistence) :
...
float ASimplexNoise::noise(float x, float y) {
...
float ASimplexNoise::fractal(size_t octaves, float x, float y) const {
	float output = 0.f;
	float denom = 0.f;
